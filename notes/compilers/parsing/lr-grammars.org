...
- Marker(.) :: Marks the parser's current position in a rule. The symbols to the left of the marker
  are those on the stack, and the symbols to the right of the marker are the next possible sequence
  of tokens.
