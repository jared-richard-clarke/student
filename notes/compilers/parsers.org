...
*** Shift-Reduce Parsing: ~integer + integer~
...
**** Tables GOTO and ACTION

- goto :: *non-terminal* through *follow*

- action :: *$* through *integer*

| non-terminal | nullable? | first     | follow    | $        | +            | *             | integer       |
|--------------+-----------+-----------+-----------+----------+--------------+---------------+---------------|
| P            | ✖         | {integer} |           |          |              |               | P ::= E $     |
| E            | ✖         | {integer} | {$}       |          |              |               | E ::= T E'    |
| E'           | ✔         | {+}       | {$}       | E' ::= ε | E' ::= + T E |               |               |
...
|------+-----------------+---------------------+---------------|
|    1 | $ E             | integer + integer $ |               |
|    2 | $ E' T          | integer + integer $ | E ::= T E'    |
|    3 | $ E' T' F       | integer + integer $ | T ::= F T'    |
|    4 | $ E' T' integer | integer + integer $ | F ::= integer |
|    5 | $ E' T'         | + integer $         | match integer |
|    6 | $ E'            | + integer $         | T' ::= ε      |
|    7 | $ E' T +        | + integer $         | E' ::= T E'   |
|    8 | $ E' T          | integer $           | match +       |
|    9 | $ E' T' F       | integer $           | T ::= F T'    |
|   10 | $ E' T' integer | integer $           | F ::= integer |
|   11 | $ E' T'         | $                   | match integer |
|   12 | $ E'            | $                   | T' ::= ε      |
|   13 | $               | $                   | E' ::= ε      |
|   14 |                 |                     | match $       |
