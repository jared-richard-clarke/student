...
Aleksey Kladov argues that Dijkstra's Shunting Yard algorithm and Pratt Parsing are the same algorithm with different
implementations. Pratt uses recursion, Dijkstra uses a stack. He implements the Shunting Yard Algorithm in Rust.
