...
The relation *⇀G* of the form *(e, o)*, where *e* is an expression and *o ∈ { 0, 1, f }*
represents an abstract simulation over the relation *⇒G*. *e ⇀ o* implies *(e, o) ∈ ⇀G*.

- If *(e, x) ⇒G (n, ε)*, the *e ⇀ 0*
...
|----------+------------------------------------------------------------|
| *e ⇀ 0*  | *e* might succeed on some string while consuming no input. |
| *e ⇀ 1*  | *e* might succeed while consuming at least one terminal.   |
| *e ⇀ f*  | *e* might fail on some input.                              |
| *s*      | Either outcome *0* or *1*.                                 |
...
5. *e_{1} e_{2} ⇀ 0* if *e_{1} ⇀ 0* and *e_{2} ⇀ 0* || *e_{1} e_{2} ⇀ 1* if *e_{1} ⇀ 1* and *e_{2} ⇀ s* || *e_{1} e_{2} ⇀ 1* if *e_{1} ⇀ s* and *e_{2} ⇀ 1*
...
*WF(e)* for *e ∈ WF_{G}* means the expression *e* is well-formed in *G*.
...
4. *WF(e_{1} e_{2})* if *WF(e_{1})* and *e_{1} ⇀ 0* implies *WF(e_{2})*

5. *WF(e_{1} / e_{2})* if *WF(e_{1})* and *WF(e_{2})*

6. *WF(e\star{})* if *WF(e)* and *e /⇀ 0*
