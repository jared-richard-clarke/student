...
#+begin_src c
  // An LPEG pattern is an abstract syntax tree and, if already compiled,
  // an accompanying array of bytecode instructions.
  typedef struct Pattern {
    union Instruction *code;
    TTree tree[1];
  } Pattern;

  // Abstract syntax tree encoded as 8-byte units inside an array.
  ...
  // A 4-byte bytecode instruction as defined in "lpvm.h".
