...
*|Π(g, i, p)|* is the number of instructions in *(g, i, p)*.

A grammar is defined as a partial function from a set of variables to a set of patterns,
such that *g(A_{k})* represents the pattern associated with non-terminal *A_{k}* of grammar *g*.

Function *o* takes a grammar *g* and a variable *A_{k}* defined in *g*, and gives the
position of the program derived from *A_{k}* in *Π'(g, i)* relative to *i*.
...
#+begin_src lua
  ...
  --               call key: 1  (rule: 0) -- Balanced: call
  --           char ')'

  -- === VM Instructions ===
  --
  -- 00: call -> 4 -- Balanced: call
  -- 02: end
  -- 03: --
  -- 04: char '(' (28) -- Balanced: body
  -- 05: testset (28-1) [(00-28)(2a-ff)]-> 18
  -- 08: testset (28-1) [(00-27)(2a-ff)]-> 14
  -- 11: any
  -- 12: jump -> 5
  -- 14: call -> 4 -- Balanced: call
  -- 16: jump -> 5
  -- 18: char ')' (29)
  -- 19: return
  -- 20: end
