...
#+begin_src lua
  ...
  Power  = Capture(Pattern("^")) * Spaces
  Open   = "(" * Spaces
  Close  = ")" * Spaces

  -- Evaluator
  function binary(x, op, y)
  ...
  Grammar = Pattern {
    Expression,
    Expression = Term * (AddSub * Term % binary) ^ 0,
    Term       = Factor * (MulDiv * Factor % binary) ^ 0,
    Factor     = Primary * (Power * Factor % binary) ^ 0,
    Primary    = Number / tonumber + Open * Expression * Close
  }

  total = lpeg.match(Grammar, "3 + 5 * 9 / (1 + 1) - 11 ^ 2") --> -95.5
#+end_src
...
#+begin_src lua
  ...
  -- 23: jump -> 54
  -- 25: return
  -- 26: testchar '.' (2e)-> 37 -- Fractional: body
  -- 28: choice -> 37
  -- 30: any
  -- 31: set (30-1) [(30-39)]
  -- 33: span (30-1) [(30-39)]
  -- 35: commit -> 37
  -- 37: return
  -- 38: testset (40-2) [(45)(65)]-> 53 -- Exponent: body
  -- 42: choice -> 53
  -- 44: any
