...
#+begin_src c
  ...
  // Pattern matching instructions encoded as an array of 4-byte or 32-bit bytecodes.
  ...
  // Stack entries encoded as an array of saved input positions,
  // alternative bytecode instructions, and indices into the capture list.
