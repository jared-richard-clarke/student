...
Samples of C source code for LPEG's ~match~ function, a function that runs
...
#+begin_src c
  ...
  // Abstract syntax tree encoded as an array of 8-byte units.
  ...
  // Pattern matching instructions encoded as an array of 4-byte bytecodes.
  ...
  // A stack encoded as an array of structs containing an input
  // position, the next bytecode instruction, and the capture level.
