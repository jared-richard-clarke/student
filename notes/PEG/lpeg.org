...
- Any n :: Advances *n* positions if the current position plus *n* is not greater than the
  length of the input. Fails otherwise.
...
#+begin_src lua
  ...
  -- 06: testany -> 9
  -- 08: fail
  -- 09: fullcapture string (size = 0)  (idx = 1)
  -- 10: commit -> 18
  -- 12: opencapture string (idx = 3)
  -- 13: any
  -- 14: fullcapture simple (size = 1)  (idx = 0)
  -- 15: call -> 4 -- R: call
  -- 17: closecapture
  -- 18: return
  -- 19: end
