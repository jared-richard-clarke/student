...
#+begin_src c
  ...
  case IRet: {
    ...
    p = (--stack)->p; // "stack" points to first empty slot in "Stack".
    continue;
  }
  ...
  // Capture (index, instruction) | (p+1, i, e, (i, p):c)
  case ICloseCapture: {
