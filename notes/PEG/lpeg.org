...
to the matched string and the capture type. A capture either pulls a value directly
from the subject or combines and/or transforms the values of other captures using
Lua strings, numbers, tables, and functions.
