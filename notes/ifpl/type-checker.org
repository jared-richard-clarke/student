...
#+begin_src haskell
  ...
  -- Functions "initUnique" and "closeOver" and data type "TypeError"
  -- are not defined here. They are part of a more elaborate
  -- Haskell compiler implementation as defined by author Stephen Diehl.
