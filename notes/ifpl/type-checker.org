...
#+begin_example
  ...
  Γ, f : {T0 ↦ T1 → T2} ⊢ λx.f x : T1 → T2
  ---------------------------------------- [Abs]                      y : (T3 → T4) → T3 → T4 ∈ Γ
  Γ ⊢ λf.λx.f x : {T0 ↦ T1 → T2} → T1 → T2                            --------------------------- [Var]
                                                   -
  Γ ⊢ λf.λx.f x : τ = (T1 → T2) → T1 → T2   Γ, y : Γ(τ) ⊢ λf.λx.f x : ∀T1.∀T2.(T1 → T2) → T1 → T2
  ----------------------------------------------------------------------------------------------- [Let]
                    Γ ⊢ let y = λf.λx.f x in y : ∀T1.∀T2.(T1 → T2) → T1 → T2
  ...
  x : T0 ∈ Γ                z : T2 ∈ Γ          y : T1 ∈ Γ                z : T2 ∈ Γ
  ----------                ----------          ----------                ----------
  Γ ⊢ x : {T0 ↦ T2 → T3}    Γ ⊢ z : T2          Γ ⊢ y : {T1 ↦ T2 → T4}    Γ ⊢ z : T2
  ------------------------------------ [App]    ------------------------------------ [App]
            Γ ⊢ x z : T3                                  Γ ⊢ (y z) : T4

                    Γ ⊢ x z : {T3 ↦ T4 → T5}    Γ ⊢ (y z) : T4
                    ------------------------------------------ [App]
                                 Γ ⊢ x z (y z) : T5
                    ...
                    Γ, y : {T1 ↦ T2 → T4} ⊢ λz. x z (y z) : T2 → T5
                    ----------------------------------------------- [Abs]
                    Γ ⊢ λy.λz. x z (y z) : {T1 ↦ T2 → T4} → T2 → T5

                    Γ, x : {T0 ↦ T2 → T4 → T5} ⊢ λy.λz. x z (y z) : (T2 → T4) → T2 → T5
                    ------------------------------------------------------------------- [Abs]
                    Γ ⊢ λx.λy.λz. x z (y z) : {T0 ↦ T2 → T4 → T5} → (T2 → T4) → T2 → T5
