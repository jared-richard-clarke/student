...
#+begin_src haskell
  -- === Syntax ===
  --
  -- The syntax of our first type inferred language will effectively
  -- be an extension of our untyped lambda calculus,
  -- with fixpoint operator, booleans, integers, let, and a few
