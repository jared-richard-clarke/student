...
#+begin_src rust
  ...
  unsafe impl GlobalAlloc for SimpleAllocator {
      unsafe fn alloc(&self, layout: Layout) -> *mut u8 {
          ...
          // "self.arena.get()" retrieves the base pointer of the arena's memory.
          // ".cast::<u8>()" converts the pointer to a raw byte pointer so that
          // pointer arithmetic is calculated in single bytes.
          // ".add(allocated)" offsets the pointer forward by "allocated".
