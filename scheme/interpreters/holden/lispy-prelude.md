...
Lispy is a functional LISP created by Daniel Holden for his book [Build Your Own Lisp](https://buildyourownlisp.com/).
The code below is the prelude — the language expanded by its own definitions.
