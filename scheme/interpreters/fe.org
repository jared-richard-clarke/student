...
#+begin_src c
  ...
  void fe_error(fe_Context *ctx, const char *msg) {
    ...
    // Error handler returned — print error and traceback, and then exit.
  ...
  // Functions for manipulating the garbage-collector stack.
  ...
  // Pull object from free list for use in program.
  // Run garbage collection if free list is empty.
  static fe_Object* object(fe_Context *ctx) {
    fe_Object *obj;
    // Collect garbage if freelist has no more objects.
  ...
  // Either pull a symbol from "symlist" or create a new one.
  ...
  // Wrap a C function within a Fe object.
  ...
  // Wrap a C pointer within a Fe object.
  ...
  // (= symbol expression)
  // Bind a Fe expression to an identifier.
