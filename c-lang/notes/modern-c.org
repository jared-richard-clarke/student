...
- Avoid taking the address of block-scope (local) variables. It is good practice to mark
  all local variables with ~register~ in complex code. ~register~ helps avoids aliasing
  between objects.
