...
#+begin_src asm
  ...
  main:
          push    rbp                           ; <+
          mov     rbp, rsp                      ;  |
          sub     rsp, 80                       ;  |- Setup up callframe for "main" function.
          ...
          mov     QWORD PTR [rbp-24], 10        ; <-- "numbers" array length
          mov     DWORD PTR [rbp-8], 0          ; <-- Start of "for" loop. Initialize "index".
          jmp     .L4                           ; <-- Jump to predicate.
  .L5:
          mov     rax, DWORD PTR [rbp-16]       ; <-- Move "index" into register "rax".
          ...
          add     DWORD PTR [rbp-16], 1         ; <-- Add increment "index" register by 1.
  .L4:
          mov     rax, QWORD PTR [rbp-16]       ; <-- Initialize "index".
          cmp     rax, QWORD PTR [rbp-24]       ; <-- Compare "index" to "length".
          jb      .L5                           ; <-- Jumps to body of "for" loop if condition is satisfied.
