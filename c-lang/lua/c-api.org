...
#+begin_src c
  ...
  #define has_error 1 // invalid flag
  #define has_i     2 // interactive
  #define has_v     4 // version
  #define has_e     8 // environment: yes
  #define has_E    16 // environment: no
  ...
  static void doREPL(lua_State* L) {
      ...
      lua_initreadline(L);
      /*
        While there is input from the terminal, parse, compile, evaluate,
        and print.
      */
  ...
  static int pmain(lua_State* L) {
      ...
      // error = argument index | no name = -1 | no script name = 0 | script name
      // = index
      int script;
