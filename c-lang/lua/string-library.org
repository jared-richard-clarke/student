...
#+begin_src c
  ...
  // string.sub(text, i [, j]) -> string
  //   where text = target string
  //         i    = start index
  //         j    = end index
  ...
  // string.rep(text, n [, separator]) -> string
  //   where text      = target string
  //         n         = total copies
...
#+begin_src c
  ...
  // string.find(text, pattern [, initial [, plain]]) -> start, end, capture ... | nil
  //   where text    = target string
  //         pattern = pattern string
  //         initial = start index
  //         plain   = plain string flag
  static int str_find(lua_State* L) { return str_find_aux(L, 1); }

  // string.match(text, pattern [, initial]) -> captures | nil
  //   where text    = target string
  //         pattern = pattern string
  //         initial = start index
  ...
  // string.gmatch(text, pattern [, initial]) -> iterator -> capture
  //   where text    = target string
  //         pattern = pattern string
  //         initial = start index
  ...
  // string.gsub(text, pattern, replacement [, count]) -> string | nil
  //   where text        = target string
  //         pattern     = pattern string
  //         replacement = replacement string, table, or function
  //         count       = replacement limit
